...
<div class="row mb-3">
    ...
    <div class="col-md-6">
        <input id="name" type="file" class="form-control @error('name') is-invalid @enderror" name="traning_image" value="{{ old('name') }}" required autocomplete="name" autofocus>
        ...
        @enderror
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="number" class="form-control @error('name') is-invalid @enderror" name="phone" value="{{ old('name') }}" required autocomplete="name" autofocus>
